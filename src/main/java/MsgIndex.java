...
public class MsgIndex extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(request.getUserPrincipal() == null) {
			...
			Entity e = new Entity("Msg", Long.MAX_VALUE-(new Date()).getTime()+":"+userService.getCurrentUser().getEmail());
			e.setProperty("owner", userService.getCurrentUser().getEmail());
			e.setProperty("url", "my URL");
			e.setProperty("body", "Un nouveau body tiens");
			e.setProperty("likec", 17);
			...
			for (Entity msg : msgs.values()) {
				response.getWriter().append("<li> Message : "+msg.getProperty("body") + "<br/> Nombre de likes : " + msg.getProperty("likec") + "<br/> Date : " + msg.getProperty("date") + "<br/><br/>");
			}
	    }
	}
